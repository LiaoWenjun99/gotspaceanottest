"""
Django settings for gotspaceanottest project.
...
SECRET_KEY = 'django-insecure-n1hmbnhwx-(4oubamo1gnr86$qmw3wchzz%ykdkia@n+k*_w(u'
...
INSTALLED_APPS = [
    ...
    'Libraryspace.apps.LibraryspaceConfig',
]
...
ROOT_URLCONF = 'gotspaceanottest.urls'
...
WSGI_APPLICATION = 'gotspaceanottest.wsgi.application'
